...
- [~] **Split agent/agent.go Run method** — The Run method is 313 lines (62% of the file). Extract into focused functions: request preparation, streaming/thinking handling, tool execution loop, response processing. Keep core orchestration in Run method. Better separation of concerns and easier testing.
